...
import { Dialog } from "@/flavors/timetable/components/ui/dialog";
import { setPrefs, usePrefs } from "@/flavors/timetable/lib/prefs-store";
import {
  CommandEmpty,
  CommandGroup,
  CommandInput,
    ...
    <>
      ...
      >
        ...
        >
          <div
            data-dark-surface
            className="flex items-center gap-3 bg-sign px-4 text-on-sign"
          >
            <span
              aria-hidden
              className="font-mono text-mono-xs font-bold tracking-[0.1em] whitespace-nowrap text-signal uppercase"
            >
              Where to?
            </span>
            <Search
            ...
            <CommandInput
              ...
              enterKeyHint="go"
              className="h-14 min-w-0 flex-1 bg-transparent text-base font-semibold text-on-sign outline-none placeholder:font-medium placeholder:text-on-sign-soft"
            />
            <Kbd className="hidden text-on-sign-soft fine:inline-flex">esc</Kbd>
          </div>
          ...
          <div
            aria-hidden
            className="hidden items-center gap-4 border-t border-rule px-4 py-2 font-mono text-mono-xs text-ink-faint fine:sm:flex"
          >
            ...
            <span className="ml-auto flex items-center gap-1.5">
              <Kbd>g</Kbd>
              then a platform number jumps to it
            </span>
          </div>
        </CommandRoot>
      </Dialog>
