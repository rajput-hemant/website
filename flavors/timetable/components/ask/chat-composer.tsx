...
/**
 * The information desk form: new questions and replies. Visitors' messages wait for
 * moderation and echo in place for the sender; the owner's publish at once.
 * On success the card briefly settles back into place.
 */
        ...
        <label
          ...
          className={
            hideLabel || collapsible
              ? "sr-only"
              : "text-h3 font-extrabold tracking-[-0.015em]"
          }
        >
          {label}
        </label>

        {/* The card settles back into place once a message is sent. */}
        <div
          ...
          className={cn(
            "rounded-md bg-surface shadow-[inset_0_0_0_1.5px_var(--color-rule-strong)] transition-[translate,scale,opacity,box-shadow] duration-(--duration-ui) ease-enter",
            !expanded && "cursor-text",
            "has-[textarea:focus-visible]:shadow-[inset_0_0_0_3px_var(--color-focus)] fine:hover:shadow-[inset_0_0_0_2px_var(--color-ink)]",
            bodyError && "shadow-[inset_0_0_0_2px_var(--color-danger)]",
            owner && "border-t-4 border-signal",
            justFiled &&
        ...
        >
          <textarea
            ...
            className={cn(
              ...
              "block [field-sizing:content] max-h-80 w-full resize-none bg-transparent px-4 leading-relaxed text-ink placeholder:text-ink-soft focus-visible:outline-none",
              !expanded
            ...
            {owner ? (
              ...
              <div className="min-w-0 flex-1 basis-40">
                ...
                <input
                  ...
                  className="h-11 w-full min-w-0 rounded-sm bg-transparent px-2 text-[0.9375rem] text-ink placeholder:text-ink-soft focus-visible:outline-offset-0 aria-invalid:text-danger sm:-ml-2"
                />
          ...
          <p className="mt-3 flex items-start gap-2 text-ink-soft">
            ...
            {status.status === "published"
              ...
              : isReply
                ...
                : "Question received. It will be posted once it's approved."}
          </p>
        )}
      </div>
    </form>
  ...
  return (
    <p
      ...
      className={cn(
        ...
        length >= max * 0.9 ? "font-bold text-danger" : "text-ink-soft"
      )}
    >
      {length}/{max}
    </p>
