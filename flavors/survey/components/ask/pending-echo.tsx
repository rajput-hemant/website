...
/** The sender's own new entries that are waiting for approval, above the notebook. */
...
/** The sender's own replies in one entry that are waiting for approval, in place. */
