...
// Source: sanity/lib/queries.ts
// Variable: NOW_QUERY
// Query: *[_type == "now" && _id == "now"][0]{  items[]{ text, link },  updatedAt}
...
// Query: *[_type == "update"] | order(date desc, _createdAt desc){  _id,  date,  text,  category,  link}
...
// Query: *[_type == "skillGroup"] | order(coalesce(order, 1000) asc, title asc){  _id,  title,  items}
...
// Query: *[_type == "education"] | order(coalesce(order, 1000) asc, endYear desc){  _id,  institution,  degree,  location,  startYear,  endYear,  score}
