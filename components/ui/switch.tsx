...
export function Switch({ className, ...props }: SwitchProps) {
  return (
    <SwitchPrimitive.Root
      ...
      {...props}
    >
      <SwitchPrimitive.Thumb className="size-3.5 rounded-[max(2px,calc(var(--radius)-3px))] bg-subtle shadow-[0_1px_2px_oklch(0_0_0/0.15)] transition-[translate,background-color] duration-200 ease-snappy data-checked:translate-x-4 data-checked:bg-accent-foreground" />
    </SwitchPrimitive.Root>
  );
}
